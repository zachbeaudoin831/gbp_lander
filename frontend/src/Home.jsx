        ...
        <section className="hero" id="top">
          <div className="wrap">
            <div className="hero-copy">
              <h1>Turn Your Business Listing Into A Landing Page <span className="ring">With Matching Ads<svg viewBox="0 0 200 24" preserveAspectRatio="none" aria-hidden="true"><path d="M4 18 C 50 8, 150 8, 196 14" /></svg></span></h1>
